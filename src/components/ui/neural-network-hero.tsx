...
export default function NeuralNetworkHero({
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen w-full overflow-hidden bg-black" style={{ position: 'relative', zIndex: 1 }}>
      ...
      <div className="relative z-20 mx-auto flex max-w-7xl flex-col items-start gap-6 px-6 pb-24 pt-36 sm:gap-8 sm:pt-44 md:px-10 lg:px-16" style={{ position: 'relative', zIndex: 20 }}>
        ...
        <h1 ref={headerRef} className="max-w-2xl text-left text-5xl font-extralight leading-[1.05] tracking-tight text-white sm:text-6xl md:text-7xl" style={{ opacity: 1, visibility: 'visible' }}>
          {title}
        </h1>

        <p ref={paraRef} className="max-w-xl text-left text-base font-light leading-relaxed tracking-tight text-white/75 sm:text-lg" style={{ opacity: 1, visibility: 'visible' }}>
          {description}
        </p>

        <div ref={ctaRef} className="flex flex-wrap items-center gap-3 pt-2" style={{ opacity: 1, visibility: 'visible' }}>
