    ...
    return (
      <ReactLenis root>
        <section className='bg-slate-950 text-white' ref={container as any}>
          {heading && (
            <div className='h-[35vh] w-full bg-slate-950 grid place-content-center relative'>
              <div className='absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:54px_54px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]'></div>
              
              <div className='relative z-10 text-center px-8 pt-16 lg:pt-24'>
                <h1 className='2xl:text-7xl text-5xl font-semibold font-figtree text-center tracking-tight leading-[120%] mb-4'>
                  {heading}
                </h1>
                {subheading && (
          ...
          <div className='text-white w-full bg-slate-950 pt-[80px]'>
